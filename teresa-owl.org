...
** TODO [1/3] Improvements to spectral maps
+ [X] Increase width of projected slit
+ [ ] Use median image to fake the vertical profile across an artificially wide slit
+ [ ] Finesse the flux calibration of slits 04 and 07
