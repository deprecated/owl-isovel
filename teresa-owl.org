...
python $mdir/multibin-map.py owl-slits-nii-allvels.fits
#+END_SRC

#+RESULTS:
: Saving owl-slits-nii-allvels-bin001.fits
: Saving owl-slits-nii-allvels-bin002.fits
: Saving owl-slits-nii-allvels-bin004.fits
: Saving owl-slits-nii-allvels-bin008.fits
: Saving owl-slits-nii-allvels-bin016.fits
: Saving owl-slits-nii-allvels-bin032.fits
: Saving owl-slits-nii-allvels-bin064.fits

#+BEGIN_SRC sh :results silent
mdir=/Users/will/Dropbox/OrionWest
redranges='+030+050 +010+030 -010+010'
for vrange in $redranges; do
    python $mdir/multibin-map.py owl-slits-ha$vrange.fits
    python $mdir/multibin-map.py owl-slits-nii$vrange.fits
done
#+END_SRC
...
#+BEGIN_SRC sh :results verbatim
ranges='+030+050 +010+030 -010+010 -allvels'
for vrange in $ranges; do
    python owl-multibin-combine.py owl-slits-ha$vrange 1e2 0.0
    python owl-multibin-combine.py owl-slits-nii$vrange 1e2 0.0
done
#+END_SRC
